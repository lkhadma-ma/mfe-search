...
@Component({
  ...
  >
    <!-- Search Input -->
    <div *ngIf="searchable" class="mfe-search-sticky mfe-search-top-0 mfe-search-bg-white mfe-search-p-3 mfe-search-border-b mfe-search-border-gray-100 mfe-search-z-10">
    ...
    <div class="mfe-search-py-2">
      ...
      >
        ...
        <span *ngIf="isSelected(option)" class="mfe-search-text-blue-600 mfe-search-font-bold">
