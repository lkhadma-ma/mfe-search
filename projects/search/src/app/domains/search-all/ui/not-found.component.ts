...
@Component({
    ...
    template: `
    <div class="mfe-search-w-full mfe-search-h-1/2 mfe-search-px-4 mfe-search-py-8 mfe-search-text-center mfe-search-text-gray-500 mfe-search-text-sm">
        ...
        <p class="mfe-search-font-medium">No result found</p>
